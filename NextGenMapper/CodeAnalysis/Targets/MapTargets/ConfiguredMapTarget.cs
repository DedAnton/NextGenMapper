...
internal readonly struct ConfiguredMapTarget
{
    public ConfiguredMapTarget(ITypeSymbol source, ITypeSymbol destination, SeparatedSyntaxList<ArgumentSyntax> arguments, bool isCompleteMethod, Location location, SemanticModel semanticModel)
    {
        Source = source;

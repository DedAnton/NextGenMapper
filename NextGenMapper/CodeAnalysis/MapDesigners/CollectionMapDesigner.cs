...
namespace NextGenMapper.CodeAnalysis.MapDesigners
{
    public class CollectionMapDesigner
    {
        ...
        public ImmutableArray<TypeMap> DesignCollectionMaps(Collection from, Collection to)
        {
            var collectionMap = new CollectionMap(from, to);

            var classMapDesigner = new ClassMapDesigner();
            var elementsMaps = classMapDesigner.DesignClassMaps(from.ElementType, to.ElementType);
        ...
        //    var classMapDesigner = new ClassMapDesigner();
        //    classMapDesigner.DesignClassMaps(elementTypeFrom, elementTypeTo);
